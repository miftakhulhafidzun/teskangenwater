    ...
    <nav class="navbar navbar-inverse navbar-fixed-top">
        ...
        <div class="container">
            <div class="navbar-header">
                <a class="navbar-brand" href="index.php"><b>Kangen Water</b></a>
            </div>
            ...
            <div>
                ...
                <ul class="nav navbar-nav navbar-right">
                    <?php if (isset($_SESSION['username'])) : ?>
                        <li class="dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><strong><?= $_SESSION['username'] ?></strong></a>
